...
In RStudio, make sure your R Markdown document ([Math Processing Error]) document is loaded in the editor
Click the [Math Processing Error] button in the doc toolbar to preview your document.
In the preview window, click the [Math Processing Error] button.
